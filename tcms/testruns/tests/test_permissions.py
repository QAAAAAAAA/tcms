...
class EditTestRunViewTestCase(PermissionsTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.new_build = factories.BuildFactory(name="FastTest", version=cls.test_run.plan.product_version)
...
class TestNewRunViewTestCase(tests.PermissionsTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.build_fast = factories.BuildFactory(name="fast", version=cls.plan.product_version)
    ...
    def verify_post_with_permission(self):
        ...
        for case, execution in zip((self.case_1, self.case_2), last_run.executions.order_by("case")):
