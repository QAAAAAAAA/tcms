...
class TestRun(models.Model, UrlMixin):
    ...
    tag = models.ManyToManyField("management.Tag", through="testruns.TestRunTag", related_name="run")
...
class TestExecution(models.Model, UrlMixin):
    ...
    case = models.ForeignKey("testcases.TestCase", related_name="executions", on_delete=models.CASCADE)
