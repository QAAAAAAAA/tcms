...
DEBUG = True if bool(os.environ.get("DEBUG", False)) else False
...
SERVER_EMAIL = DEFAULT_FROM_EMAIL = "sunh@sea.com"
...
EMAIL_PORT = 587
EMAIL_HOST_USER = "sunh@sea.com"
EMAIL_HOST_PASSWORD = "mbwptbqomdamfqjv"
...
# social auth
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = "env_oauth2_key"
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = "env_oauth2_secret"
...
SOCIAL_AUTH_PIPELINE = (
    ...
    "tcms.utils.permissions.social_auth_users_handler",
)
...
MENU_ITEMS = [
    ...
    (
        ...
        [
            ...
            (_("New Bug"), reverse_lazy("bugs-new")) if "tcms.bugs.apps.AppConfig" in INSTALLED_APPS else (),
        ],
    ),
    (
        _("SEARCH"),
        [
            ...
            (_("Search Bugs"), reverse_lazy("bugs-search")) if "tcms.bugs.apps.AppConfig" in INSTALLED_APPS else (),
        ],
    ),
    (
        _("TELEMETRY"),
